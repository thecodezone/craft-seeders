...
use CodeZone\seeders\models\Settings;
use Craft;
...
class Seeders extends Plugin
{
    ...
    public function init()
    {
        ...
        if (Craft::$app instanceof ConsoleApplication) {
            $this->controllerNamespace = 'CodeZone\seeders\console\controllers';
        }

        $this->setComponents([
            'seeders' => \CodeZone\seeders\services\Seeders::class,
        ]);
